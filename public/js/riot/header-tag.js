    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse float-right" id="navbarMenu">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item" data-toggle="collapse" data-target="#navbarMenu.show" each="{ section, i in get_sections() }"><a class="nav-link" href="" onclick={ go_to }>{ sections[authenticated()][section].label }</a></li>
            </ul>
        </div>
    </nav>
